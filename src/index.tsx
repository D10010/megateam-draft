          ...
          <div class="max-w-6xl mx-auto">
            ...
            <div id="megateam-login" class="mt-20" data-aos="fade-up" data-aos-delay="600">
              <div class="text-center mb-8">
                ...
                <div class="inline-flex items-center px-3 py-2 md:px-4 md:py-2 bg-yellow-600/30 border border-yellow-500/60 rounded-full text-yellow-400 text-xs md:text-sm font-bold mb-4 shadow-lg">
